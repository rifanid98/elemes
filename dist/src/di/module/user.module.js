...
const user_handler_1 = require("../../adapter/handler/user.handler");
...
UserModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([repository_1.UserLocalRepository]),
        ],
        controllers: [user_handler_1.UserHandler],
        providers: [...provider_1.UserProvider, jwt_strategy_1.JwtStrategy, logger_1.MainLogger],
